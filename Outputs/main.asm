...
;	assignBit
	clr	_RCK
;	../main.c:58: exe_command(FUNCTION_SET);
	mov	dptr,#0x3c00
	lcall	_exe_command
;	../main.c:59: exe_command(ENTRY_MODE_SET);
	mov	dptr,#0x1e00
	lcall	_exe_command
;	../main.c:60: exe_command(CLEAR_DISPLAY);
	mov	dptr,#0x8000
	lcall	_exe_command
;	../main.c:61: exe_command(DISPLAY_ON);
	mov	dptr,#0x3000
	lcall	_exe_command
...
;	../main.c:77: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:78: exe_command(0x1080);
	mov	dptr,#0x1080
	lcall	_exe_command
;	../main.c:79: exe_command(0x3080);
	mov	dptr,#0x3080
	lcall	_exe_command
;	../main.c:80: exe_command(0x7080);
	mov	dptr,#0x7080
	lcall	_exe_command
;	../main.c:81: exe_command(0x3080);
	mov	dptr,#0x3080
	lcall	_exe_command
;	../main.c:82: exe_command(0x1080);
	mov	dptr,#0x1080
	lcall	_exe_command
;	../main.c:83: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:84: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:87: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
...
;	../main.c:92: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:93: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:94: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:97: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
...
;	../main.c:104: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:107: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:108: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
...
;	../main.c:114: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:117: exe_command(0x2080);
	mov	dptr,#0x2080
	lcall	_exe_command
;	../main.c:118: exe_command(0x7080);
	mov	dptr,#0x7080
	lcall	_exe_command
;	../main.c:119: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:120: exe_command(0x5080);
	mov	dptr,#0x5080
	lcall	_exe_command
;	../main.c:121: exe_command(0x7080);
	mov	dptr,#0x7080
	lcall	_exe_command
;	../main.c:122: exe_command(0x5080);
	mov	dptr,#0x5080
	lcall	_exe_command
;	../main.c:123: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:124: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:127: exe_command(0xF880);
	mov	dptr,#0xf880
	lcall	_exe_command
;	../main.c:128: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:129: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:130: exe_command(0x5080);
	mov	dptr,#0x5080
	lcall	_exe_command
;	../main.c:131: exe_command(0x7080);
	mov	dptr,#0x7080
	lcall	_exe_command
;	../main.c:132: exe_command(0x5080);
	mov	dptr,#0x5080
	lcall	_exe_command
;	../main.c:133: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:134: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:137: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:138: exe_command(0xC080);
	mov	dptr,#0xc080
	lcall	_exe_command
;	../main.c:139: exe_command(0xD880);
	mov	dptr,#0xd880
	lcall	_exe_command
;	../main.c:140: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:141: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:142: exe_command(0x8880); 
	mov	dptr,#0x8880
	lcall	_exe_command
;	../main.c:143: exe_command(0x7080);
	mov	dptr,#0x7080
	lcall	_exe_command
;	../main.c:144: exe_command(0x0080);
	mov	dptr,#0x0080
	lcall	_exe_command
;	../main.c:150: tick_ui();
	lcall	_tick_ui
;	../main.c:153: CKCON |= 0x08; //timer0
	mov	r6,_CKCON
	orl	ar6,#0x08
	mov	_CKCON,r6
;	../main.c:154: TMOD = 0x00; //timer0 
	mov	_TMOD,#0x00
;	../main.c:155: ET0 = 1; //timer0
;	assignBit
	setb	_ET0
;	../main.c:158: blackout();
	lcall	_blackout
;	../main.c:159: PWM_EA1 = 0x48;
	mov	_PWM_EA1,#0x48
;	../main.c:160: PWM_EA2 = 0x02;
	mov	_PWM_EA2,#0x02
;	../main.c:163: while(tick--){}
	mov	r4,#0xdd
	mov	r5,#0x8a
	mov	r6,#0x14
	mov	r7,#0x00
...
;	assignBit
	setb	_REN
;	../main.c:173: RCAP2L = BAUD_TIMER_LOW;
	mov	_RCAP2L,#0xfd
;	../main.c:174: RCAP2H = BAUD_TIMER_HIGH;
	mov	_RCAP2H,#0xff
;	../main.c:175: RCLK = 1;
;	assignBit
	setb	_RCLK
...
;	assignBit
	clr	_CPRL2
;	../main.c:183: TH3 = BREAK_TIMER_RELOAD_HIGH;
	mov	_TH3,#0xfc
;	../main.c:184: TL3 = BREAK_TIMER_RELOAD_LOW;
	mov	_TL3,#0xd0
;	../main.c:187: EIE |= EIE_Timer3;
	mov	r2,_EIE
	orl	ar2,#0x01
	mov	_EIE,r2
;	../main.c:188: ES = 1;
...
;	assignBit
	clr	_P2_3
;	../main.c:195: power_heater(HEATER_DISABLE);
	mov	dpl,#0x01
	push	ar7
	push	ar6
	push	ar5
...
;	../main.c:198: while(1){
00111$:
;	../main.c:200: if(!(tick % FOGGER_FREQ)) { tick_fogger(); }
	...
	pop	ar7
00105$:
;	../main.c:202: if(!(tick % WIRELESS_FREQ)) { tick_wireless(); }
	...
	pop	ar7
00107$:
;	../main.c:204: if(!(tick % UI_FREQ)) { tick_ui(); }
